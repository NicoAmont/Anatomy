    ...
    <div class="caracteristicas">
        ...
        <div class="caracteristicas-contenedor">
            ...
            <div class="envios">
                ...
                <p class="caracteristicas_envios">Envío Gratis &<br>Devoluciones</p>
                <p class="caracteristicas_envios_2" >Anatomy Colombia cuenta con servicio de Contra entrega en Bogotá y el domicilio es Gratis . 
                Tambien realizamos envíos a todo el país a través de Interrapidisimo o Servientrega hasta la dirección que indiques, para esto debes
                primero consignar el valor del uniforme y el domicilio se lo pagas directamente a la empresa de mensajería cuando recibas el producto.
                Una vez enviado el pedido, se te pasa vía whatsapp la guía de transporte como comprobante que fue despachado<br>
                Aceptamos devoluciones en situaciones especiales :<br><br>
                •	Defecto en costuras<br>
                •	Defecto en cierres (cremalleras)<br>
                •	Error en envió de talla<br>
                •	Error en envió de color <br><br>
                Si deseas realizar la devolución lo puedes hacer en un termino  máximo de 3 dias siguientes de haber recibido el uniforme</p>
            ...
            <div class="devoluciones">
                ...
                <p class="caracteristicas_envios_2" >Contamos con garantía extendida en todas nuestras líneas y productos para prestarte un servicio de altísima calidad:<br>
                •	Por tema de costuras: Garantía  de 8 días
                •	Por tema de cierres (cremalleras) : Garantía de 1 mes</p>
            </div>
            <div class="entregas">
                ...
                <p class="caracteristicas_envios_2 caracteristicas_fin" >Contamos con soporte al cliente para resolver y atender todas tus inquietudes en el menor tiempo posible. Escríbenos al whatsapp 322 8248344 y nuestros asesores te brindaran la información</p>
